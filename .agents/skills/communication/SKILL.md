...
- **Cập nhật KI:** Khi có những thay đổi lớn về kiến trúc hoặc quy tắc mới, AI chủ động cập nhật lại các file KI tương ứng để duy trì "bộ nhớ dài hạn" chính xác.
