...
export function BottomTabBar() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-[100] bg-white/95 border-t border-gray-100 pb-safe shadow-[0_-8px_25px_rgba(0,0,0,0.08)] select-none">
        ...
        {TABS.map((tab) => {
          ...
          return (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  'flex flex-col items-stretch flex-1 h-full transition-all active:bg-gray-50/80 cursor-pointer relative',
